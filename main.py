...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        button_emit_laser = ttk.Button(frame_laser, text='EMIT', command=self.emit)
        button_stop_laser = ttk.Button(frame_laser, text='STOP', command=self.stop_laser, style='stop.TButton')
        ...
        button_emit_laser.grid(row=0, column=2)
        button_stop_laser.grid(row=0, column=3)
